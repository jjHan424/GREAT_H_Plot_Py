...
for site in site_list:
    ...
    while cur_doy <= end_doy:
        ...
        # PPPRTK_file = PPPRTK_file + os.path.join(cal_dir,"PPP","{}{:0>3}".format(2023,cur_doy),"client",         "{}-GEC3-{}-30-3600.flt".format(site,mode)) + ","
        PPPRTK_file = PPPRTK_file + os.path.join(cal_dir+"","PPPRTK","{}{:0>3}".format(2023,cur_doy),"client","{}-GEC3-{}-30-3600.flt".format(site,mode)) + ","
        # PPPRTK_file1 = PPPRTK_file1 + os.path.join(cal_dir+"_LSQ","PPPRTK_MeanBug_5MIN","{}{:0>3}".format(2023,cur_doy),"client","{}-GEC3-{}-30-3600.flt".format(site,mode)) + ","
        ...
        # PPP_file1 = PPP_file1 + os.path.join(cal_dir,"PPP","{}{:0>3}".format(2023,cur_doy),"client",         "{}-GEC3-{}-30.flt".format(site1,mode)) + ","
        # PPP_file2 = PPP_file2 + os.path.join(cal_dir,"PPP","{}{:0>3}".format(2023,cur_doy),"client",         "{}-GEC3-{}-30.flt".format(site2,mode)) + ","
        # PPPRTK_file1 = PPPRTK_file1 + os.path.join(cal_dir,"PPPRTK","{}{:0>3}".format(2023,cur_doy),"client","{}-GEC3-{}-30.flt".format(site1,mode)) + ","
        # PPPRTK_file2 = PPPRTK_file2 + os.path.join(cal_dir,"PPPRTK","{}{:0>3}".format(2023,cur_doy),"client","{}-GEC3-{}-30.flt".format(site2,mode)) + ","
        cur_doy = cur_doy + 1
    if "DELTA" in plot_type:
        file_info_list = [
            [PPP_file[:-1],REF_file[:-1],"PPPAR-{}".format(site)],
            [PPPRTK_file[:-1],REF_file[:-1],"PPPRTK-{}".format(site)],
            [PPPRTK_file1[:-1],REF_file[:-1],"PPPRTK-BUG-{}".format(site)]
        ]
        # file_info_list = [
