...
file_info_list = [
    [r"E:\PhD_1\4.RTZTD\Server\ZTD\CNE\UPC1CNERTS_20251030000_01D_05M_DARW00AUS_TRO.TRO","CNE"],
    # [r"E:\PhD_1\4.RTZTD\Server\ZTD\WHU\UPC1WHURTS_20251030000_01D_05M_DARW00AUS_TRO.TRO","WHU"],
    [r"E:\PhD_1\4.RTZTD\Server\ZTD\GFZ\UPC1GFZRTS_20251030000_01D_05M_DARW00AUS_TRO.TRO","GFZ"],
...
start_time = [2025,4,13,0,0,0]
end_time = [2025,4,13,24,0,0]
plot_type = "ZWD_RAW" # ZWD_DELTA ZWD_RAW GRD_RAW GRD_DELTA
ylim = 0 # mm for Delta
save_dir = ""
fixed = False
show = True
